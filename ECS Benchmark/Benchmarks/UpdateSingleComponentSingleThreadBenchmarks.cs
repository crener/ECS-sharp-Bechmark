...
{
    [MemoryDiagnoser()]
    public class UpdateSingleComponentSingleThreadBenchmarks : UpdateBase
    {
        public override void Setup()
        {
            ...
            m_leoLiteSystem = new Leopotam.EcsLite.EcsSystems(m_leoLiteWorld)
                .Add(new Frameworks.LeoEcsLite.ChangeSystem());
